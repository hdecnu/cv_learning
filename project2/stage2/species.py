...
def train_model(model, criterion, optimizer, num_epochs=50):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            print('{} Loss: {:.4f}  Acc_class: {:.2%}'.format(phase, epoch_loss,epoch_acc_species))
...
model, Loss_list, Accuracy_list_species = train_model(network, criterion, optimizer, num_epochs=10)
